...
**The Braintree iOS Visa Checkout SDK requires Xcode 9.2, Base SDK of iOS 9.3+, and Visa Checkout SDK for iOS v6.2**. It permits a Deployment Target of iOS 9.3 or higher.
